...
$hasJobId = isset($_SESSION['embedding_generation_job_id']) && isset($_SESSION['embedding_generation_customgpt_id']);
$hasToken = isset($_SESSION['embedding_generation_token']) && isset($_SESSION['embedding_generation_customgpt_id']);
...
if ($hasJobId) {
    $jobId = $_SESSION['embedding_generation_job_id'];
    ...
    if ($completed) {
        ...
        unset($_SESSION['embedding_generation_job_id']);
